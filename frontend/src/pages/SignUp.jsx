      ...
      <main className="flex-grow flex justify-center items-start overflow-y-auto px-6 py-12 md:py-16 bg-white text-gray-900">
        <div className="w-full max-w-2xl animate-fade-in-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <button className="flex items-center justify-center gap-3 border border-gray-300 rounded-custom py-3 px-4 hover:bg-gray-50 transition-premium btn-premium shadow-sm cursor-pointer">
