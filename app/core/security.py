import base64
import os  # FIXED: Moved from inline to top-level import for better performance
from datetime import datetime, timedelta, timezone
from typing import Any, Dict, Optional
from cryptography.hazmat.primitives.ciphers.aead import AESGCM
import jwt  # Assumes pyjwt is pinned in your requirements.txt
...
def encrypt_credentials(data: str) -> str:
    ...
    nonce = os.urandom(12)  # FIXED: Clean call utilizing global import namespace
...
def create_refresh_token(user_id: str) -> str:
    ...
    return create_jwt_token(
        data={"sub": user_id, "type": "refresh"}, expires_delta=expires
    )


def verify_token(token: str, expected_type: str = "access") -> Optional[Dict[str, Any]]:
    """Decodes and validates a JWT token safely handling signature exceptions."""
    try:
        payload = jwt.decode(
        ...
        jwt.PyJWTError,
        AttributeError,
    ):  # FIXED: Safe-gated library exception fallback to prevent runtime crashes
        return None